...
//        url28 = nil;
        ...
        [newManagedObject29 setValue:@"Dotterels dart around on beaches and mudflats. The banded dotterel is easily identified by its breeding colours being a narrow dark band on its neck and a wide chestnut band on the breast. Its back and wings are fawn. The Maori name for dotterel is tuturiwhatu. The banded dotterel is the most numerous dotterel in New Zealand and is both endemic (only found here) to New Zealand and a protected species. The banded dotterel breeds in a variety of habitats including on coasts, farms, and on the shores of lakes and riverbeds. They are most common in inland Canterbury and the Mackenzie Basin. The male makes several nests for the female to choose from and these are scrapes on sand or soil. Both the male and female incubate two to four eggs. After breeding, most of the inland breeding birds - slightly over half of the total population of 50,000 - migrate to Australia for winter." forKey:@"item_description"];
...
//        newManagedObject53= nil;
        ...
        [newManagedObject61 setValue:@"http://en.wikipedia.org/wiki/Redpoll" forKey:@"link"];
        ...
        [newManagedObject69 setValue:@"The New Zealand falcon is a magpie-sized raptor that feeds predominantly on live prey. Adapted to hunt within the dense New Zealand forests they are also found in more open habitats such as tussocklands and roughly grazed hill country. More recently they have been discovered breeding in exotic pine plantations. Laying their eggs in simple scrapes they can nest in a variety of locations, from within the epiphytes that grow in large trees, to on the ground under small rocky outcrops. Where they nest on the ground they are well known for attacking intruders, including humans, with aggressive dive-bombing strikes to the head." forKey:@"item_description"];
       ...
       [newManagedObject72 setValue:@"A total of 125 birds was known in September 2012. All carry radio transmitters and are intensively monitored and managed. It is possible there are a few birds remaining on Stewart Island, and perhaps even a few in Fiordland. Once found throughout New Zealand, kakapo started declining in range and abundance after the arrival of Maori. They disappeared from the North Island by about 1930, but persisted longer in the wetter parts of the South Island. The last birds died out in Fiordland in the late 1980s. A population of less than two hundred birds was discovered on Stewart Island in 1977, but this population was also declining due to cat predation. During the 1980s and 1990s the entire known population was transferred to Codfish Island off the coast of Stewart Island, Maud Island in the Marlborough Sounds and Little Barrier Island in the Hauraki Gulf. Since then birds have been moved between Codfish, Maud and Little Barrier Islands as well as to and from newly predator-free Chalky and Anchor Islands in Fiordland. Kakapo now occur only on forested islands, though they previously appeared to have inhabited a wide range of vegetation types." forKey:@"item_description"];
...
//        [newManagedObject72 setValue:@"kakapo" forKey:@"sound"];
        ...
        Identification: Wrybills are small, pale plovers that are much more approachable than most New Zealand waders. Their underparts are white, with a black upper breast band from mid-winter to the end of the breeding season. The upper parts and sides of the face are pale grey, and the forehead white. The bill is long and black, with the distal third curved 12-26° to the right. The legs are dark grey to black. The sexes are alike in eclipse plumage; juveniles lack the black breast band. In breeding plumage, males are distinguishable by a black line above the forehead; this is highly variable however, and difficult to see in some individuals.\
        ...
        Habitat: Wrybills breed exclusively on braided riverbeds. On their wintering grounds, they feed on inter-tidal mudflats in harbours and estuaries. High-water roosts are usually near foraging areas, commonly on local shellbanks and beaches;  occasionally on pasture. In the upper Manukau Harbour, birds regularly roost on roofs of large buildings; occasionally on tarmac at Auckland Airport. On migration, flocks generally follow coastlines, but are not averse to flying overland. A high proportion of the population passes through Lake Ellesmere on both migrations." forKey:@"item_description"];
        ...
        [newManagedObject76 setValue:@"The New Zealand pipit is a small brown-and-white songbird that resembles a lark, but has longer legs, and walks rather than hops. They are birds of open country, including the tideline of sandy beaches, rough pasture, river beds and above the tree-line. Pipits are members of the wagtail family, and frequently flick their long tails as they walk. In flight their tails have narrow white sides – a character shared with skylarks, chaffinches, yellowhammers and cirl buntings." forKey:@"item_description"];
        ...
        [newManagedObject77 setValue:@"Stints are the smallest of the migratory waders – barely the size of a sparrow. The red-necked stint is the only stint species to regularly occur in New Zealand, with up to 200 spending the southern summer here each year. They are most often seen at high-tide roosts associating with other small waders, especially wrybills, and other sandpipers. A tiny wader with dark legs and a short straight black bill, which in breeding plumage has a distinctive rufous ‘balaclava’ but otherwise is pale grey-brown above and off-white below throughout the year. The dorsal feathers have dark shafts and pale fringes, the flight feathers are dark and the rump is white with a dark centre." forKey:@"item_description"];
        ...
        [newManagedObject81 setValue:@"Shovelers are specialist filter-feeding waterfowl with a large spoon-shaped or shovel-shaped bill that is almost twice as broad at its tip than at its base and which is the bird’s most conspicuous feature. Fine lamellae extend along most of the edge of the upper mandible and it is by pushing water through this lamellae curtain that small plankton and fine seeds are extracted.\
         ...
         Voice: Australasian shovelers are rarely vocal. Displaying males have a rapid “chuff-chuff” call, and females may give a typical descending quack quack quack." forKey:@"item_description"];
